...
module.exports = async (req, res) => {
  ...
  await sendEmail({ from: SEND_FROM, to: NOTIFY_TO, cc: NOTIFY_CC_MARTIN, replyTo: email, subject: `Makler-Anfrage – ${ansprechpartner}${firma ? ' (' + firma + ')' : ''}`, html }).catch(e => console.error('Mail-Fehler:', e));
